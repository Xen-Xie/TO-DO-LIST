...
function createTodoItem(todo, todoIndex) {
    ...
    todoLi.innerHTML = ` 
      <li id="${todoId}" class="mb-[10px] px-6 py-0 bg-[#1c1d20] rounded-[15px] flex items-center">
        ...
        <label for="checkbox-${todoId}" class="p-15px pr-0 flex-grow peer-checked:line-through peer-checked:text-[#4A4D57] transition-all duration-200">
            ${todo}
        </label>
